...
SSL = os.environ.get("SSL_ENABLED") or False

BASE_URL = os.environ.get("HASS_HOME_ASSISTANT_SERVICE_HOST") or "http://hassio/homeassistant"
    ...
    for button in config["buttons"]:
        ...
        if mac == button_address:
            ...
            if "url" in button:
                ...
                if SSL:
                    header_protocol = "https://"
                else:
                    header_protocol = "http://"

                url_request = header_protocol + BASE_URL + ":8123/api/services/{0}/{1}".format(
